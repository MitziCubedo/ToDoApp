package com.nearsoft.androidschool.todoapp.activities.main.detail;
...
import com.nearsoft.androidschool.todoapp.activities.main.Notification.AlarmHandler;
import com.nearsoft.androidschool.todoapp.activities.main.Notification.NotificationPublisher;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void setSwitchListener() {
        ...
        notificationSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked && todoItem.getDate() != null) {
